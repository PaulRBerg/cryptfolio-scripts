...
const TIMEZONE = "UTC";
const VERSION = "18"; // auto-signed version number generated by Google for the Apps Script library deployment
...
function validateJSONResponse_(response, context) {
  ...
  if (statusCode >= 400 && statusCode < 500) {
    ...
    throw new Error(`${context}: HTTP ${statusCode} error - ${preview}${text.length > 200 ? "..." : ""}`);
  }
