...
// biome-ignore assist/source/useSortedKeys: we want to keep the order of the chains
const ChainNameMap = {
  abstract: ChainId.abstract,
  arb: ChainId.arbitrum,
  arbitrum: ChainId.arbitrum,
  "arbitrum one": ChainId.arbitrum,
  ...
  "lightlink phoenix": ChainId.lightlink,
  "lightlink phoenix mainnet": ChainId.lightlink,
  linea: ChainId.linea,
  "linea mainnet": ChainId.linea,
...
const RpcUrl = {
  ...
  [ChainId.monad]: "https://rpc1.monad.xyz",
  ...
  [ChainId.xdc]: "https://rpc.ankr.com/xdc",
